...
public class Función_Sobrecargada2 {
...
static double Suma (double Num1, double Num2) {
	...
	static long Suma (long Num1, long Num2) {
		
		System.out.println("\n");

		long Resultado = Num1 + Num2;
		
		System.out.println("Este Es El Resultado De La Suma Con Long: " + Resultado);
	...
	public static void main(String[] args) {
		...
		// FUNCIÓN SOBRECARGADA SUMA CON FOR
		
		Suma();
		
		// FUNCIÓN SOBRECARGADA SUMA CON LONG
		
		Suma(11500000, 555999);
