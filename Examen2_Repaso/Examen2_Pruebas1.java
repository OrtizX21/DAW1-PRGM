...
public class Examen2_Pruebas1 {
	...
	public static void main(String[] args) {
		...
		//4. BORRAR TODOS LOS ELEMENTOS QUE SEAN EL NUMERO 11 EN LA TABLA.
		...
		//6. TRARTAR LA TABLA DE MANERA ORDENADA
		...
		System.out.println("Tabla Insertandole El 0 Importando El Orden:" + Arrays.toString(Tabla1));
	}
